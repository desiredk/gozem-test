    ...
    suggestions: [
      {
        ...
        link: '/cash-collect/dashboard'
      },
      {
        icon: 'tabler:adjustments-dollar',
        suggestion: 'Transactions',
        link: '/cash-collect/transactions/list'
      },
      {
        icon: 'tabler:brand-cashapp',
        suggestion: 'Points of sale',
        link: '/cash-collect/points-of-sale/list'
      },
      {
        icon: 'tabler:map-pin-dollar',
        suggestion: 'Agencies',
        link: '/cash-collect/agencies/list'
      }
    ]
  },
  {
    ...
    suggestions: [
      ...
      //   suggestion: 'Settings',
      //   link: '/cash-collect/app-settings'
      // },
      {
        icon: 'tabler:users',
        suggestion: 'Users',
        link: '/cash-collect/users/list'
      }
    ]
  }
]
